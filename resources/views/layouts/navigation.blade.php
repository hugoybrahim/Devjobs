        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @can('create', App\Models\Vacante::class)
                    ...
                    class="mr-2 w-7 h-7 bg-gray-600 hover:bg-gray-800 rounded-full flex flex-col justify-center items-center text-sm 
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if (auth()->user()->rol === 2)
                    <div class="flex gap-2 items-center p-3">
                        <a href="{{ route('notificaciones') }}" 
                        class="w-7 h-7 bg-gray-600 hover:bg-gray-800 rounded-full flex flex-col justify-center items-center text-sm 
                        font-extrabold text-white">
                            {{ auth()->user()->unreadNotifications->count() }}
                        </a>
